...
var Basics = function Basics() {
  ...
  }, "The basics of being a Council Member for Dijets"), __jsx("p", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 29,
  ...
  }, "Learn the basic action stages for proposals in Dijets Council")), __jsx(Process, {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
  ...
  }, "1- PROPOSAL IS SUBMITTED"), __jsx("div", {
  ...
  }, "2- COUNCILLORS ARE DRAFTED"), __jsx("div", {
  ...
  }, "3- PROPOSAL IS REVIEWED"), __jsx("div", {
  ...
  }, "4- PRELIMINARY VOTING"), __jsx("div", {
  ...
  }, "Dijets Governance Council is responsible for steering Dijets and the interests of its stakeholders in a favourable direction. Each of the 6 Council Members are free to submit, review and vote on a proposal."))), __jsx(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_2__["default"].Item, {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 98,
  ...
  }, "2- COUNCILLORS ARE DRAFTED"), __jsx("p", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 102,
  ...
  }, "Each time a proposal is submitted, the council members will receive an automatic email confirming the submission. Members are advised to review the proposal at their earliest convenience."))), __jsx(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_2__["default"].Item, {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 109,
  ...
  }, "3- PROPOSAL IS REVIEWED"), __jsx("p", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 113,
  ...
  }, "The review process can range from going through the proposal breakdown and its finer details. A summary report and a template for DIPs should accompany each proposal."))), __jsx(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_2__["default"].Item, {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 120,
  ...
  }, "At the end of the Review period, the Council Members can start to Vote for their desired outcome."))), __jsx(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_2__["default"].Item, {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 130,
  ...
  }, "The Adjudication round for the proposal's qualification begins when HAL starts measuring each member's input for the respective proposal."))), __jsx(react_bootstrap_Carousel__WEBPACK_IMPORTED_MODULE_2__["default"].Item, {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 141,
  ...
  }, "HAL autonomously executes each proposal that receives the majority consent of the members. At the end of this process HAL upgrades or downgrades the Likability Quotient for each member accordingly."))))));
};
...
//# sourceMappingURL=index.js.336c890f5d485a2b19e4.hot-update.js.map